...
const floatingProfiles = [
  { name: "Anna M.", role: "AI Engineer", position: "top-36 left-[10%]" },
  { name: "John D.", role: "Data Scientist", position: "top-48 left-[25%]" },
  { name: "Mike R.", role: "Full Stack Dev", position: "top-32 right-[25%]" },
  { name: "Sara K.", role: "UX Designer", position: "top-44 right-[10%]" },
